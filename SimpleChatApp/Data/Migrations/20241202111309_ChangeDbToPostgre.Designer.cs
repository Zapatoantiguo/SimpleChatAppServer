...
namespace SimpleChatApp.Data.Migrations
{
    ...
    [Migration("20241202111309_ChangeDbToPostgre")]
    partial class ChangeDbToPostgre
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleChatApp.Models.Notifications.InviteNotification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SimpleChatApp.Models.Notifications.InviteNotification", b =>
                {
                    b.HasOne("SimpleChatApp.Models.User", "TargetUser")
                        .WithMany()
